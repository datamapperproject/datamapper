...
var proms = [
  ...
  {name: "compare", type: "verb", column: 0, action:1, active : true, links : ["linkC"]},
  {name: "cases", type: "subject", column:1, action:1, active : false, links : ["linkC"]},
  ...
  {name: "situate", type: "verb", column: 0, action:4, active : true, links : ["linkH"]},
  {name: "concepts", type: "subject", column:1, action:4, active : false, links : ["linkH"]},
  {name:"to craft", type:"verb2", column:2, action:4, active : false, links : ["linkD", "toolD"]},
